...
class Database:
    ...
    def __init__(self): #adding self gives this function a paramter, which will allow for one parameter to be called
        connection = sqlite3.connect("books.db") #OPTIONAL! Ypu can add another parameter, "db", and replace "books.db" with "db"
